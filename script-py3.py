...
def mainScript(serie, season="", episode=""):
    ...
    if counter > 0:                                                                     # If at least 1 good result
        ...
        os.system("python3 send_message.py \""+messageToSend+"\""        # Set var "python hangupsapi/examples/send_message.py <oldest link>")
        
        messageToSend = "Link: " + resultLinks[0]
        os.system("python3 send_message.py \""+messageToSend+"\"")
